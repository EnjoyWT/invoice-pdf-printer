...
const { checkLicenseStatus: checkLicenseStatusFn, verifyLicense } = useLicense()
...
const checkIpcStatus = () => {
  ...
  console.log('window.electronAPI.checkLicenseStatus:', window.electronAPI?.checkLicenseStatus)
  
  if (window.electronAPI && typeof window.electronAPI.checkLicenseStatus === 'function') {
